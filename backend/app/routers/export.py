...
from app.repositories import envio_maritimo_repo, envio_terrestre_repo
...
def export_terrestres(
    ...
    items, _ = envio_terrestre_repo.list_all(
        db, estado, fecha_inicio, fecha_fin, cliente_id, page=1, size=10_000
    )
...
def export_maritimos(
    ...
    items, _ = envio_maritimo_repo.list_all(
        db, estado, fecha_inicio, fecha_fin, cliente_id, page=1, size=10_000
    )
