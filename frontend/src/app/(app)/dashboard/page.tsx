    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 380px', gap: 16 }}>
        ...
        <div style={{
          ...
          <div style={{ fontFamily: fonts.display, fontSize: 14, fontWeight: 600, color: colors.textMuted, letterSpacing: '0.06em', marginBottom: 12 }}>
            RUTAS ACTIVAS
          </div>
        ...
        <div style={{
          ...
          <div style={{ fontFamily: fonts.display, fontSize: 14, fontWeight: 600, color: colors.textMuted, letterSpacing: '0.06em', marginBottom: 16 }}>
            ACTIVIDAD RECIENTE
          </div>
          ...
          {!recientes ? (
            ...
            <p style={{ color: colors.textDim, fontSize: 13, fontFamily: fonts.body }}>Sin envíos recientes.</p>
          ) : (
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
              {recientes.items.map((envio) => (
                <div key={envio.id} style={{
                  display: 'flex', justifyContent: 'space-between', alignItems: 'center',
                  padding: '10px 12px', background: colors.panelAlt,
                  borderRadius: radius.md, borderLeft: `2px solid ${colors.amber}`,
                }}>
                  <div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: 12 }}>
            {[
              ...
              <div key={label} style={{
                ...
                background: `${color}10`, borderRadius: radius.md,
                border: `1px solid ${color}30`,
              }}>
                <div style={{ fontSize: 28, fontFamily: fonts.display, fontWeight: 700, color }}>{value}</div>
                <div style={{ fontSize: 11, color: colors.textMuted, fontFamily: fonts.body, marginTop: 4 }}>{label}</div>
              </div>
            ))}
          </div>
        </div>
